...
, pulsed_beam(_pulsed_beam) {
    ...
    processor = Postprocessor(config_manager,
                              dir_manager);
    ...
    logger = Logger<PulsedBeam<Medium>, Postprocessor>(config_manager, dir_manager, processor, pulsed_beam,
